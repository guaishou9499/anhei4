...
local common = {
	VERSION      = '20211016.28',
	AUTHOR_NOTE  = '-[common module - 20211016.28]-',
	MODULE_NAME  = '公共模块', 
}
...
------------------------------------------------------------------------------------
-- 预载函数(重载脚本时)
common.super_preload = function()
    -- xxmsg('item.super_preload') 
end

common.ui_ding = function()
	local ui_list = ui_res.UI_LIST
	local msgbox_title = ui_unit.get_msgbox_title()
	local msgbox_content = ui_unit.get_msgbox_content()
	for i, v in pairs(ui_list) do
		if v.title == msgbox_title and v.content == msgbox_content then
			v.func()
			sleep(5000)
			break
		end
	end
	common.time_end_game()
end

common.time_end_game = function()
	if user_set_ent['下线时间'] == 0 then
		return false
	end
	if common.get_time_h() >= user_set_ent['下线时间'] then
		sleep(1000)
...
-- @usage
-- local str_t = common.split('待分割的字符串', '分割段')
-- print_t(str_t)
--------------------------------------------------------------------------------
common.split = function(str, split_char)
...
-- @usage
-- local bool = common.is_rang_by_point(目标点的x坐标,,目标点的y坐标,圆心的x坐标,圆心的y坐标,圆的半径)
--------------------------------------------------------------------------------
common.is_rang_by_point = function(x, y, x1, y1, R)
    --
    local x2, y2 = x1 - R, y1
...
-- @usage
-- local number = common.get_dis_by_two_point(第一个点的x坐标,,第一个点的y坐标,第二个点的x坐标,第二个点的y坐标)
--------------------------------------------------------------------------------
common.get_dis_by_two_point = function(x, y, x1, y1)
...
-- @treturn      number  年
-- @usage
-- local year = common.get_time_year()
--------------------------------------------------------------------------------
common.get_time_year = function()
...
-- @treturn      number  月份
-- @usage
-- local mon = common.get_time_mon()
--------------------------------------------------------------------------------
common.get_time_mon = function()
...
-- @treturn      number  当日
-- @usage
-- local day = common.get_time_day()
--------------------------------------------------------------------------------
common.get_time_day = function()
...
-- @treturn      number  当前时
-- @usage
-- local h = common.get_time_h()
--------------------------------------------------------------------------------
common.get_time_h = function()
...
-- @treturn      number  当前分
-- @usage
-- local m = common.get_time_m()
--------------------------------------------------------------------------------
common.get_time_m = function()
	return tonumber(os.date("%M"))
end
...
-- @treturn      number  当前秒
-- @usage
-- local s = common.get_time_s()
--------------------------------------------------------------------------------
common.get_time_s = function()
...
-- @treturn      number  星期
-- @usage
-- local w = common.get_time_w()
--------------------------------------------------------------------------------
common.get_time_w = function()
...
-- @usage
-- local time = common.get_day_sixh()
--------------------------------------------------------------------------------
common.get_day_sixh = function()
...
-- @treturn      boolean
-- @usage
-- local bool = common.between(比较值,最大区间,最小区间)
--------------------------------------------------------------------------------
common.between = function(num, max_num, min_num)
	if num < min_num then
		return false
	end
	if num > max_num then
...
-- @return      boolean
-- @usage
-- local bool = common.is_in_list(目标,列表)
--------------------------------------------------------------------------------
...
-- @return      table
-- @usage
-- local table = common.merge_table(表1,表2)
--------------------------------------------------------------------------------
...
-- @return      boolean
-- @usage
-- local bool = common.is_in_table(目标,列表,'字段')
--------------------------------------------------------------------------------
...
-- @return      table
-- @usage
-- local table = common.expand_table(表,'字段')
--------------------------------------------------------------------------------
...
-- @return      table
-- @usage
-- local table = common.get_point_on_circle(圆心x坐标,圆心y坐标,半径,点的数量)
--------------------------------------------------------------------------------
